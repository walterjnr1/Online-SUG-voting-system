...
<head>
  ...
  <title>Dashboard |Online SUG Voting system</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h6><strong><?php echo $row_no_users;?></strong></h6>

                <p><strong>No. of Voters </strong></p>
              </div>
              <div class="icon">
                <i class=""></i>
              </div>
    ...
    { 
        // it return number of rows in the table. 
        $row_no_cand = mysqli_num_rows($result); 
    ...
    ?>
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h6><?php echo $row_no_cand; ?></h6>

                <p><strong>No. of Candidates </strong></p>
              </div>
              <div class="icon">
                <i class=""></i>
              </div>
