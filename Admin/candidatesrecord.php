...
<head>
  ...
  <title>Candidates/Votes Record|Online SUG Voting System</title>
 ...
 <link rel="shortcut icon" href="../images/logo.jpg" type="image/x-png" />
  ...
  <script type="text/javascript">
		function deldata(candName){
if(confirm("ARE YOU SURE YOU WISH TO DELETE " + " " + candName+ " " + " FROM THE LIST?"))
{
return  true;
}
else {return false;
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Candidates' Record</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <td width="1155"><div class="card">
                ...
                <div class="card-body">
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    <thead>
                      <tr> <th width="3%">#</th>
					   <th width="13%">Candidate ID</th>
                        <th width="13%">Candidate Name</th>
						<th width="7%">Reg No.</th>
						<th width="9%">No of Votes</th>
						 <th width="7%">Marital Status</th>
                        <th width="7%">Sex</th>
                        <th width="7%">Phone</th>
						 <th width="8%">Address</th>
                        <th width="8%">Dept</th>
                        <th width="9%">Faculty</th>
						<th width="8%">year of Admission</th>
                        <th width="9%">Level</th>
						<th width="9%">Photo</th>
					  ...
					  <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        ...
                        <td><div align="center"><?php echo $row['candName']; ?></div></td>
                        	<td><div align="center"><?php echo $row['regNo']; ?></div></td>
								  <td><div align="center"> <span class="badge badge-primary"><?php echo $row['count']; ?></span></div></td>
					<td><div align="center"><?php echo $row['maritalstatus']; ?></div></td>
                        ...
                        <td><div align="center"><?php echo $row['yearadmission']; ?></div></td>
                        ...
                        <td><a href="delete-voter.php?id=<?php echo $row['regNo'];?>" onClick="return deldata('<?php echo $row['candName']; ?>');">Delete </a></span></td>
                      </tr>
                      <?php $cnt=$cnt+1;} ?>
                    </tbody>
                    <tfoot>
