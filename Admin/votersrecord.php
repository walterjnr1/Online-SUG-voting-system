...
<head>
  ...
  <title>Voters Record|Online SUG Voting System</title>
 ...
 <link rel="shortcut icon" href="../images/logo.jpg" type="image/x-png" />
  ...
  <script type="text/javascript">
		function deldata(voterName){
if(confirm("ARE YOU SURE YOU WISH TO DELETE " + " " + voterName+ " " + " FROM THE LIST?"))
{
return  true;
}
else {return false;
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Voters' Record</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <td width="1155"><div class="card">
                ...
                <div class="card-body">
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                							      <?php 
                                          $sql = "SELECT * FROM voter order by voterName ASC";
                                           $result = $conn->query($sql);
										$cnt=1;
					  ...
					  <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        ...
                        <td><div align="center"><?php echo $row['accesscode']; ?></div></td>
                        ...
                        <td><div align="center"><?php echo $row['yearofadmission']; ?></div></td>
                        ...
                        <td><a href="delete-voter.php?id=<?php echo $row['regNo'];?>" onClick="return deldata('<?php echo $row['voterName']; ?>');">Delete </a></span></td>
                      </tr>
                      <?php $cnt=$cnt+1;} ?>
                    </tbody>
                    <tfoot>
