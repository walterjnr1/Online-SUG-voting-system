...
$password = $_POST['txtpassword'];
 ...
 $sql = "SELECT * FROM admin WHERE username='" .$username . "' and password = '". $password."'";
    ...
    $row  = mysqli_fetch_array($result);
     ...
     if(count($result)==1 && isset($_SESSION["admin-username"])) {
    {       
...
<head>
  ...
  <title>Admin login|Online SUG Voting System</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b><img src="../images/authentication.png" width="100" height="100"><span class="style1">Foundation Polytechnic Ikot Idem  </span></b><span class="style1"></span></a>  </div>
  <!-- /.login-logo -->
  <div class="card">
