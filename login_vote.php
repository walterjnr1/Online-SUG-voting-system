...
$regno = $_POST['txtregNo'];
 ...
 $sql = "SELECT * FROM voter  WHERE regNo='".$regno."' and accesscode = '".$accesscode."'";
...
$msg_error = "Wrong Reg No or Access Code";
}
}
...
<head>
<title>Voters' Login System</title>
    ...
    <table width="667" border="0" align="center">
      <tr>
        <td><div class="mainbar">
          <div class="article">
            <p align="center">&nbsp; </p>
            <table width="590" height="362" border="0" align="center">
              <tr>
                <td width="584" height="97">
				<?php if ($msg <> "") { ?>
  <style type="text/css">
<!--
.style1 {
...
<?php } ?>
<?php echo "<p> <font color=red font face='arial' size='3pt'>$msg_error</font> </p>"; ?><?php echo "<p> <font color=green font face='arial' size='3pt'>$msg_success</font> </p>"; ?></p></td>
              </tr>
              <tr>
                    ...
                    <tr>
                      <td><form id="login_form" name="form1" method="post" action="">
                          <table width="333" border="0">
                            ...
                            <tr>
                              <td><span class="style10">Access Code  :</span></td>
                              <td><input name="txtaccesscode" type="text" id="txtaccesscode" value=""></td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                              <td><p align="center"><a href="voterReg.php" class="style11">Register Here </a></p></td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
