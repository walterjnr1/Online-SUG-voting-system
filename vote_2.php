...
<title>CANDIDATE VOTING PLATFORM</title>
...
<div id="footer">
  ...
  <p class="style3">VOTER'S NAME : - <?php echo " <strong><font face='Verdana' size='5' color=red>".$rowaccess['candName']." </font></strong>";  ?></p>
  <p class="style2">REG NO. : - <?php echo " <strong><font face='Verdana' size='5' color=red>".$rowaccess['regNo']." </font></strong>";  ?></p>
  ...
  <table width="85%" align="center" class="table table-bordered table-striped" id="resultTable">
                   ...
                   <tbody>
                    ...
                    <td><div align="center"><span class="controls"><img src="<?php echo $row['photo'];?>"  width="53" height="41" border="2"/></span></div></td>
                       <td><div align="center"><span class="style6"><a href="vote_exec_2.php?id=<?php echo $row['candID'];?>" onClick="return confirmvote('<?php echo $row['candName']; ?>');">Vote Here</a>
