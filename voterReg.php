...
$votername = mysqli_real_escape_string($conn,$_POST['txtvotername']);
...
$query_insert_user = "INSERT INTO voter ( voterName, accesscode, regNo, maritalStatus,sex, DOB, phone, address,lga, state, dept, faculty, yearadmission, level,photo) VALUES ('$votername','$accesscode', '$regNo', '$maritalstatus','$sex', '$DOB', '$phone', '$address','$lga', '$state', '$dept', '$faculty','$yearadmission', '$level', '$photo')";
 if ($conn->query($query_insert_user) === TRUE) {

$_SESSION['votername']=$votername;
$_SESSION['VregNo']=$regNo;
$_SESSION['accesscode']=$accesscode;
                // Finish the page:
//$msg_success = "Voter registered Successfully";
header('location:voter_pic.php');
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="voterReg.php">Voter Registration </a></li>
            ...
            <table width="216" height="137" border="0" align="center">
              <tr>
                <td width="209"><form id="form1" name="form1" method="post" action="">
                  <table width="519" border="0" align="right">
                    <tr>
                      <th width="513" scope="col"><div align="center">
  ...
  &nbsp;</div></td>
                    ...
                    <tr>
                      <td height="236"><div id="div-regForm">
                          <div class="form-title">VOTER'S REGISTRATION </div>
                          <div class="form-sub-title">Registration is free for Eligible Voters  </div>
                          <table width="395" cellpadding="11" cellspacing="13">
                            <tbody>
                              <tr>
                                <td width="76"><span class="style19">
                                    <label for="fname"> </label>
                                    <label for="fname">
                                    </span>
                                    <div align="left" class="style19">VOTER'S NAME </div>
                                  <span class="style19">
                                    </label>
                                  </span></td>
                                <td width="234"><div class="input-container">
                                    <input name="txtvotername" type="text" id="txtvotername" required />
                                </div></td>
                              </tr>
                              <tr>
                                <td><span class="style19">
                                    ...
                                    <div align="left" class="style19">ACCESS CODE: </div>
                                    <span class="style19">
                                    </label>
                                  </span></td>
                                <td><div class="input-container">
                                    <input name="txtaccesscode" id="txtaccesscode" readonly="readonly" type="text" value="<?php function generatePIN($digits = 6){ $i = 0; //counter
...
<div class="footer">
  <div class="footer_resize"><span class="style29"><?php include('footer.php'); ?></span></div>
</div>
<!-- END PAGE SOURCE -->
