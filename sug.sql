...
--
-- Host: localhost
-- Generation Time: Oct 27, 2018 at 07:01 PM
...
CREATE TABLE IF NOT EXISTS `candidate` (
  ...
  `yearadmission` varchar(15) NOT NULL,
...
INSERT INTO `candidate` (`candName`, `candID`, `regNo`, `maritalstatus`, `sex`, `DOB`, `phone`, `address`, `lga`, `state`, `dept`, `faculty`, `yearadmission`, `level`, `post`, `pin`, `photo`) VALUES
('UBONG ETOK JNR', 'CID236793', 'AKP/ASC/CSC/HND2016/0610', 'SINGLE', 'MALE', '07/02/2000', '090', '34 UYO RD , IKOT EKPENE', 'Nkanu East', 'Enugu', 'COMPUTER SCIENCE', 'SCIENCE', '2016', '300', 'President', '1111483647', 'uploads/hg6.jpg'),
('SOLOMON EDEAH', 'CID308619', 'AKP/ASC/CSC/HND2016/0001', 'SINGLE', 'MALE', '9/12/1987', '080534545644', '8 IKOT EKPENE RD,IKOT EKPENE', 'Essien Udim', 'Akwa Ibom', 'COMPUTER SCIENCE', 'SCIENCE', '2016', '200', 'President', '2221483647', 'uploads/ChunLiDraw_1440x900.jpg');
...
INSERT INTO `count` (`candID`, `candName`, `count`) VALUES
('CID236793', 'UBONG ETOK JNR', '7'),
('CID308619', 'SOLOMON EDEAH', '0');
...
INSERT INTO `pin` (`pin_num`, `status`) VALUES
('1111483647', 'Used'),
('2221483647', 'Used'),
('1890483647', 'unused'),
('9000483900', 'unused'),
...
('walterjnr1', 'escobar2012', '08067361023', 'Ndueso Walter Okorie', 'uploads/1.jpg');
...
INSERT INTO `voter` (`voterName`, `voterID`, `regNo`, `maritalstatus`, `sex`, `DOB`, `phone`, `address`, `lga`, `state`, `dept`, `faculty`, `yearadmission`, `level`, `photo`) VALUES
('IFIOK UYANGA', 'ID730376', 'AKP/ASC/CSC/HND2016/0649', 'SINGLE', 'FEMALE', '09/09/1999', '080534545644', '3 MARKET RD, EKET', 'Obanliku', 'Cross River', 'COMPUTER SCIENCE', 'SCIENCE', '2016', '200', 'uploads/11.jpg'),
('NDUESO WALTER OKORIE', 'ID781756', 'AKP/ASC/CSC/HND2016/0680', 'SINGLE', 'MALE', '12/09/1999', '090', '12 ABA RD, IKOT EKPENE', 'Anambra East', 'Anambra', 'COMPUTER SCIENCE', 'SCIENCE', '2016', '200', 'uploads/1232.jpg');
...
CREATE TABLE IF NOT EXISTS `voting` (
  `candID` varchar(15) NOT NULL,
  `candName` varchar(44) NOT NULL,
  `voterID` varchar(22) NOT NULL,
  `voterName` varchar(44) NOT NULL,
  `voteTime` varchar(22) NOT NULL,
  PRIMARY KEY (`voterID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `voting` (`candID`, `candName`, `voterID`, `voterName`, `voteTime`) VALUES
('CID236793', 'SOLOMON EDEAH', 'ID730376', 'IFIOK UYANGA', '2018-10-27 18:12:34'),
('CID236793', 'SOLOMON EDEAH', 'ID781756', 'NDUESO WALTER OKORIE', '2018-10-27 18:11:39');
