...
<head>
<title><?php echo $_SESSION['candName'] ;?></title>
                  ...
                  <table width="505" border="0" align="center">
                    <tr>
                      <th width="499" scope="col"><div align="center">
                          <table width="417" border="0" align="center">
                            <tr>
                              <td height="53"><div align="center"><span class="style12"> CANDIDATE'S PHOTO  </span>&nbsp;</div></td>
                            </tr>
                          </table>
                      </div></th>
                    </tr>
                    <tr>
                      <td height="236"><table width="212" border="0" align="center">
                        ...
                        <tr>
                          <td><p align="center">&nbsp;</p>
                            <p align="center"><strong><span class="style30"> <span class="style31">NAME</span>:</span> <?php echo " <strong><font face='Verdana' size='3' color=blue>".$_SESSION['candName']." </font></strong>";  ?></strong></p>
                            <p align="center">&nbsp;                         </p></td>
                        </tr>
                        <tr>
                          <td><p align="center"><strong><span class="style32">REG NO.</span> :<span class="style23"><span class="propic"><?php echo " <strong><font face='Verdana' size='3' color=blue>".$_SESSION['regNo']." </font></strong>";  ?></span></span></strong></p>
                            <p align="center">&nbsp;</p>
                            <p align="center"><strong><span class="style32">CANDIDATE NO.</span>: <?php echo " <strong><font face='Verdana' size='3' color=blue>".$_SESSION['candID']." </font></strong>";  ?></strong></p>
